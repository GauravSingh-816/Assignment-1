...
int main() {
	...
	while (file.fail()) {
		file.clear();
		cout << "Cannot find file, please enter again" << endl;
		cin >> filename;
	...
	do
	{
		...
		case '1':
			...
			cout << "Enter an integer to see if it exists in the array: " << endl;
			cin >> a;
			findindex(arr, 100, a);
			break;
		case '2':
			// modifies an integer at a certain index
		...
		case '3':
			...
			try {
				...
				cout << "Please try again with an integer above 0" << endl;
			}
			break;
		case '4':
			// removes an integer at a certain index
